  ...
  return (
    <View>
      ...
      onPress={() => navigation.navigate("Info",{
        ...
        style={{ marginStart: 12, marginEnd:12, marginTop:8, flexDirection: "row", backgroundColor: "white", borderRadius:10 }}
      >
        <View>
          <Image
        ...
        <View style={{ padding: 10 }}>
          ...
          >
            ...
            <Text style={{ fontSize: 18, fontWeight:600, color:"#2a9df4" }}>
